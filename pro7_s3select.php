<table align="center">
	<tr align="center">
		<td>
			<font face="Impact" size="5"><b>ใบสั่งซื้อ</b></font><br><br>
		</td>
	</tr>
	<tr align="center">
		<td>
				...
				if((int)phpversion() >= 7) {
					...
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							echo "orderid : ".$row["orderid"]."- productid : ".$row["productid"]."- unitprice : ". $row["unitprice"]."- quantity : ". $row["quantity"]."- discount : ". $row["discount"]."<br/>";
						}
					} else {
						echo "no results";
					}
