<table align="center">
	<tr align="center">
		<td>
			<font face="Impact" size="5"><b>พนักงาน</b></font><br><br>
		</td>
	</tr>
	<tr align="center">
		<td>
				...
				if((int)phpversion() >= 7) {
					...
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							echo "id_employeeid : ".$row["id_employeeid"]."- firstname : ".$row["firstname"]."- lastname : ". $row["lastname"]."- title : ". $row["title"]."- birthdate : ". $row["birthdate"]."<br/>";
						}
					} else {
						echo "no results";
					}
