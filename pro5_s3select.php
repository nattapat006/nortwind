<table align="center">
	<tr align="center">
		<td>
			<font face="Impact" size="5"><b>ผู้จำหน่าย</b></font><br><br>
		</td>
	</tr>
	<tr align="center">
		<td>
				...
				if((int)phpversion() >= 7) {
					...
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							echo "supplierid : ".$row["supplierid"]."- companyname : ".$row["companyname"]."- contactname : ". $row["contactname"]."- contacttitle : ". $row["contacttitle"]."- address : ". $row["address"]."<br/>";
						}
					} else {
						echo "no results";
					}
