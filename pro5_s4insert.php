...
<form action="pro5_s4insert.php">
<table width="600" align="center" border="0">
	<tr>
		<font face="Impact" size="5">ผู้จำหน่าย</font>
	...
	<tr align="center">
		<td>
			<a href="pro5_s0index.php"><p><button class="w3-btn w3-ripple w3-hover-red">Back</button></p></a>
		</td>
	</tr>
</table><br><br><br>
<!--<table align="center">
...
$sql="insert into $tb values('".$_GET['supplierid']."','".$_GET['companyname']."','".$_GET['contactname']."','".$_GET['contacttitle']."','".$_GET['address']."')";
if((int)phpversion() >= 7) {
